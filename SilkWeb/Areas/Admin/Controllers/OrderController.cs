...
namespace SilkWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetAll(string status)
        {
            ...
            if (User.IsInRole(SD.Role_Admin) || User.IsInRole(SD.Role_Employee))            //all orders should only be visible to admin/employees 
            {                                                                               //and rest user should see their respective orders only
